...
const FavouriteList = () => {
  ...
  return (
    <div>
      ...
      <p className="note">To view favorite list you must be logged in !</p>
        ...
        {favorites.map((article) => (
          <li key={article.title} className="favourite-item">
            <img
              src={
                article.urlToImage ||
                "https://s.france24.com/media/display/d1676b6c-0770-11e9-8595-005056a964fe/w:1024/p:16x9/news_1920x1080.png"
              }
              alt={article.title}
